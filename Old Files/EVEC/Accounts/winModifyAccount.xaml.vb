...
Partial Public Class winModifyAccount
    ...
    Private Sub winModifyAccount_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Closing
        ' Close the connection
        objConnection.Close()
    End Sub

    Private Sub winModifyAccount_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
